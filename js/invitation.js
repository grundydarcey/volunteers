...
//variable that tracks the click of the 'submit' button
//var btn = document.getElementById('submitButton');

//this function prevents the page from refreshing and keeps the customized invitation relevant to the user
